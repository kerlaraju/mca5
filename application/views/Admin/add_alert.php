    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">
                        <a href="<?= base_url('index.php/alert_messages') ?>">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Add Alert Message</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="card-body">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Alert Message</h3>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?PHP if(isset($alert_info)){ echo $alert_info->message_title;}else{ echo ""; } ?>" class="form-control" placeholder="Enter Message Title" name="message_title" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Message</label>
                                    <input type="text" value="<?PHP if(isset($alert_info)){ echo $alert_info->message;}else{ echo ""; } ?>" class="form-control" placeholder="Enter Message" name="message" required>
                                </div>
                            </div>
                        </div> 
                         <div class="row">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Alert Message List</h4>
            ...
            <form id="form" action="" method="post">
                <div class="modal-body">
                    ...
                    <div id="message_id_block" style="display:none" class="form-group">
                        <label>Message Id</label>
                        <input type="text" id="Message_id" class="form-control" placeholder="Message ID" disabled>
                    </div>
                    <div class="form-group">
                        <label>Message title</label>
                        <input type="text" id="message_title" class="form-control" placeholder="Enter Message Title">
                    </div>
