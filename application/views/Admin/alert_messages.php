                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                    ...
                                    <a href="<?= base_url('index.php/edit_alert/'.$x->message_id); ?>"><i class="fa fa-edit"> </i></a>
                                
                                    <a href="<?= base_url('index.php/delete_alert/'.$x->message_id); ?>"><i class="fa fa-trash"> </i></a>
                        ...
                        <td> <?PHP echo $x->message_title; ?> </td>
                        <td> <?PHP echo $x->message; ?> </td>
                         <td> <?PHP echo $x->from_date; ?> </td>
                        <td> <?PHP echo $x->to_date; ?> </td>
