                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div>
                                    ...
                                    <a href="<?= base_url('index.php/edit_dis/'.$x->district_id); ?>"><i class="fa fa-edit"> </i></a>
                                
                                    <a href="<?= base_url('index.php/delete_dis/'.$x->district_id); ?>"><i class="fa fa-trash"> </i></a>
